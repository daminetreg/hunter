...
hunter_config(BZip2 VERSION 1.0.6-p1 CMAKE_ARGS BUILD_SHARED_LIBS=ON )
...
hunter_config(cpplinq VERSION 20150908)
...
hunter_config(lib-cpp-pre VERSION 1.2.2)
hunter_config(Libgit2 VERSION 0.23.1)
...
hunter_config(QtAndroidCMake VERSION 1.0.5)
...
hunter_config(ZLIB VERSION 1.2.8-p3 CMAKE_ARGS BUILD_SHARED_LIBS=ON )
hunter_config(ccv VERSION 0.7-p6)
hunter_config(cereal VERSION 1.1.2-p5)
hunter_config(cvmatio VERSION 1.0.26)
hunter_config(dbus VERSION 1.10.0-hunter-3)
...
hunter_config(nlohmann-json VERSION 1.0.0-rc1-hunter-1)
